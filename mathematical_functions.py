...
def find_fixed_points(I, s, g, a, A):
    values = optimize.fixed_point(iterate_2d_sys_fixed_point, [[-0.5,-0.5],[0.01,0.01],[0.5,0.5]], args=(s, g), maxiter=2000)
    return values

def iterate_2d_sys_fixed_point(u1, s, g):
    return g*sigmoid(s[focal_neurons[0]][focal_neurons[1]])*sigmoid(u1)